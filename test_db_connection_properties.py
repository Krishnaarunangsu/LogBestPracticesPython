...
def get_db_conn_properties():
    ...
    return db_url, db_port, db_user_name, db_user_password, db_name
        #, db_charset
...
class DatabaseConnectionHelper:
    ...
    def __enter__(self):
        ...
        db_url, db_port, db_user_name, db_user_password, db_name = get_db_conn_properties()
        ...
        self.db_conn = pyodbc.connect(db_config)
        print(self.db_conn)
...
if __name__ == "__main__":
    get_db_conn_properties()
   # db_helper = DatabaseConnectionHelper()
   # print(db_helper)
    with DatabaseConnectionHelper as db_helper:
        print(db_helper)
